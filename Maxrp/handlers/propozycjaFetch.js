    ...
    if(message.channel.id === config.propozycjaChannelID) {
        if (message.content.startsWith("%")) {
            ...
            const successEmbed = new Discord.MessageEmbed()
                ...
                .setAuthor('💬 Komentarz', '', '')
                .setFooter(config.serverName + "MaxRP 2.0 ■ Autor: " + message.author.tag);
            ...
            const successEmbed = new Discord.MessageEmbed()
                ...
                .setFooter(config.serverName + "MaxRP 2.0 ■ Autor: " + message.author.tag + " ■ Aby dodać komentarz wpisz przed wiadomościa %");
